...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public View onCreateView(
    ...
    TrackSelectionView trackSelectionView = dialogView.findViewById(R.id.track_selection_view);
  ...
  private static String getTrackTypeString(Resources resources, @C.TrackType int trackType) {
    switch (trackType) {
      case C.TRACK_TYPE_VIDEO:
        return resources.getString(R.string.error_unsupported_video);
      case C.TRACK_TYPE_AUDIO:
        return resources.getString(R.string.error_unsupported_audio);
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      TrackSelectionView trackSelectionView = rootView.findViewById(R.id.track_selection_view);
